...
//    let messageArray = ["First message" , "Second message" , "Third message"]
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        //^ in here .child("Messages") is the child of the main database
        let messagesDict = ["Sender" : Auth.auth().currentUser?.email , "MessageBody" : messageTextfield.text]
        //v while using setting value u also need a completion handler i.e., a trailing closure
